      ...
      <main className={classes.main}>
        ...
        <div className={classes.content}>
          <p className={classes.p}>
            ...
            concepts, each following the 5-Step Creation Process&mdash;a systems
            approach created by our team in collaboration with teachers across
            New Zealand.
          </p>
          <p className={classes.p}>
            Our lesson plans and resources provide teachers with the right
            knowledge and confidence to deliver each project. These are
            complemented with learning journals&mdash;personalised documents for
            students to note ideas, thought processes and answers.
          </p>
        </div>
